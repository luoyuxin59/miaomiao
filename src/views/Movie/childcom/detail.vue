...
export default {
  ...
  mounted() {
    this.axios.get('/mock/detail.json').then(res => {
...
<style scoped>
.tetail{ position: absolute; left:0; top:0; z-index: 100; width:100%; min-height:100%; background:white;}
.tetail {animation: .3s sildeMove;}
@keyframes sildeMove {
